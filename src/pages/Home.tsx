...
const Home = () => {
  ...
  return <>
      ...
      <section className="relative h-screen flex items-center">
        <div className="absolute inset-0 bg-gradient-to-r from-[#001a36]/95 to-[#001a36]/80 z-10 my-0 mx-0 px-0 py-0"></div>
        <div className="absolute inset-0">
          <div className="w-full h-full">
            <img src="/lovable-uploads/908cdee3-d2b9-45bb-86fb-3a7fe2ad3529.png" alt="Construction site" className="w-full h-full object-cover" />
          </div>
        </div>
        <div className="container mx-auto px-4 relative z-20">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-4 animate-fade-in">
              <Button asChild className="bg-[#d0bc8f] hover:bg-[#c0b080] text-white rounded-md" size="lg">
                <Link to="/projects" className="flex items-center gap-2">
                  View Projects <ArrowRight size={16} />
                </Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-[#001a36] rounded-md">
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-12">
            <Button asChild variant="outline" className="border-[#d0bc8f] text-[#001a36] hover:bg-[#d0bc8f] hover:text-white dark:text-white">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Button asChild className="bg-[#d0bc8f] hover:bg-[#c0786a] text-white">
                <Link to="/about">Learn More About Us</Link>
              </Button>
            </div>
            <div className="relative">
              <div className="aspect-video bg-gray-200 dark:bg-gray-700 rounded-lg overflow-hidden">
                <img src="/lovable-uploads/32b4e699-e55b-4f8f-87ff-3542be16fcce.png" alt="Fine Engineering Works" className="w-full h-full object-cover" />
              </div>
      ...
      <section className="py-20 bg-[#f5f5f0] dark:bg-gray-900">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {featuredProjects.map(project => <div key={project.id} className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-md">
                ...
                <div className="p-6">
                  ...
                  <Link to={`/projects/${project.id}`} className="text-[#d0bc8f] hover:text-[#c0786a] flex items-center gap-1 text-sm font-medium">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Button asChild className="bg-[#d0bc8f] hover:bg-[#c0786a] text-white" size="lg">
                <Link to="/contact">Contact Us</Link>
              </Button>
              <Button asChild variant="outline" className="border-white text-white hover:bg-white hover:text-[#001a36]" size="lg">
                <a href="https://wa.me/8520917090" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
